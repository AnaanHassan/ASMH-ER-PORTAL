    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <div className="text-center mb-6">
          <h1 className="text-xl font-bold text-gray-800">Dr. Abdul Samad Memorial Hospital</h1>
          <p className="text-sm text-gray-500 mt-1">Emergency & Trauma Department</p>
          <h2 className="text-lg font-semibold text-blue-800 mt-4">ER Portal Login</h2>
        </div>
